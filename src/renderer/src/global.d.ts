...
declare global {
  ...
  interface Window {
    api: {
      ...
      getBootstrapState: () => Promise<{ ok: boolean; storageMode?: string; storageRoot?: string; dbPath?: string; secretsPath?: string; isFirstRun?: boolean; dbExists?: boolean; hasSecrets?: boolean; productsCount?: number; requiresInitialSync?: boolean; skipInitialSync?: boolean; error?: string }>
